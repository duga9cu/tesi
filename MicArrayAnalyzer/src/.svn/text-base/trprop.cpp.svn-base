...
wxString AFTrackInfoItem::GetLabel() 
{
...
WX_DEFINE_OBJARRAY(ArrayOfTrackInfoItems);

int AFTrackProperties::CompareTrackInfoItems(AFTrackInfoItem* first, AFTrackInfoItem* second)
{
